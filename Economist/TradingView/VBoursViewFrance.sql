...
create    view [dbo].[VBoursViewFrance]
as
with cte as(
select b.*, 
...
from BoursViewFrance b
where not exists(select 1 from [dbo].BoursViewFrance b2 where b.Symbol = b2.Symbol and b2.createdate > b.createdate)
)
select Id
,[Symbol]
