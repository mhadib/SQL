...
CREATE view  [dbo].[VBoursPortugal]
...
from BoursPortugal b
--join BoursPortugalHistorical bh on b.Name = bh.Name
where not exists(select 1 from [dbo].BoursPortugal b2 where b.Name = b2.Name and b2.createdate > b.createdate) )
