...
, cast(cf.['هزینه‌های مالی']/10000000000 as decimal(20,0)) ['هزینه‌های مالی']
, cast(cf.['خالص سایر درآمدها و هزینه‌های غیرعملیاتی']/10000000000 as decimal(20,0)) ['خالص سایر درآمدها و هزینه‌های غیرعملیاتی']
, cast(cf.['سایر درآمدهای عملیاتی']/10000000000 as decimal(20,0)) ['سایر درآمدهای عملیاتی']
, cast(cf.['سایر هزینه‌های عملیاتی']/10000000000 as decimal(20,0)) ['سایر هزینه‌های عملیاتی']


, cast(cf.['هزینه مالیات بر درآمد سال جاری']/10000000000 as decimal(20,0)) ['هزینه مالیات بر درآمد سال جاری']
, cast(cf.['هزینه استهلاک']/10000000000 as decimal(20,0)) ['هزینه استهلاک']
, cast(cf.['هزینه های عمومی, اداری و تشکیلاتی']/10000000000 as decimal(20,0)) ['هزینه های عمومی, اداری و تشکیلاتی']
, cast(cf.['هزینه های تولید']/10000000000 as decimal(20,0)) ['هزینه های تولید']
, cast(cf.['هزینه سهم مشارکت در منافع']/10000000000 as decimal(20,0)) ['هزینه سهم مشارکت در منافع']
, cast(cf.['سود (زیان) ناخالص فعالیتهای بیمه ای']/10000000000 as decimal(20,0)) ['سود (زیان) ناخالص فعالیتهای بیمه ای']
, cast(cf.['هزینه کاهش ارزش دریافتنی‌‏ها (هزینه استثنایی)']/10000000000 as decimal(20,0)) ['هزینه کاهش ارزش دریافتنی‌‏ها (هزینه استثنایی)']
, cast(cf.['هزینه تامین منابع مالی عملیات لیزینگ']/10000000000 as decimal(20,0)) ['هزینه تامین منابع مالی عملیات لیزینگ']
, cast(cf.['سایر هزینه های بیمه ای']/10000000000 as decimal(20,0)) ['سایر هزینه های بیمه ای']
, cast(cf.['هزینه مالیات بر درآمد سال‌های قبل']/10000000000 as decimal(20,0)) ['هزینه مالیات بر درآمد سال‌های قبل']
, cast(cf.['سایر درآمدها و هزینه‌های غیرعملیاتی - اقلام متفرقه']/10000000000 as decimal(20,0)) ['سایر درآمدها و هزینه‌های غیرعملیاتی - اقلام متفرقه']
, cast(cf.['هزینه ارائه خدمات']/10000000000 as decimal(20,0)) ['هزینه ارائه خدمات']

,cast(cf.['درآمدهای عملیاتی']/10000000000 as decimal(20,0))  ['درآمدهای عملیاتی']
,null ['بهای تمام ‌شده درآمدهای عملیاتی']
,cast(cf.['سود (زیان) عملیاتی']/10000000000 as decimal(20,0))  ['سود (زیان) عملیاتی']
